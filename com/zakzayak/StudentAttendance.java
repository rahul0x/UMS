...
public class StudentAttendance extends JFrame implements ActionListener{
    ...
    StudentAttendance(){
        ...
        comboBox.setModel(new DefaultComboBoxModel(new String[] { "-Select-","B.Tech", "M.Tech", "MBA", "BBA", "BCA", "Bsc", "MCA", "Msc" }));


        if(comboBox.getSelectedItem() == "B.Tech") code = 0;
        if(comboBox.getSelectedItem() == "M.Tech") code = 1;
        if(comboBox.getSelectedItem() == "BBA") code = 2;
        if(comboBox.getSelectedItem() == "MBA") code = 3;
        if(comboBox.getSelectedItem() == "BCA") code = 4;
        if(comboBox.getSelectedItem() == "MCA") code = 5;
        if(comboBox.getSelectedItem() == "Bsc") code = 6;
        if(comboBox.getSelectedItem() == "Msc") code = 7;
