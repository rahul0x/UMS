...
public class TeacherDetails extends JFrame implements ActionListener{
    ...
    JButton b1,b2,b3;
    JTextField t2;
    String x[] = {"Name","Father's Name","Mother's Name","Date of Birth","Address","Phone","Email","Class X(%)", "Class XII(%)", "Aadhar No","Course","Department", "Employee Id"};
    ...
    TeacherDetails(){
        ...
        setLayout(null);
        setResizable(false);
        l1 = new JLabel("Enter Emp number to delete Teacher : ");
